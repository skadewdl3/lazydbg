...
pub fn gen_grid(element: &Element) -> TokenStream2 {
...
pub fn gen_grid_item(element: &Element) -> TokenStream2 {
...
pub fn gen_grid_item_push(node: &Node, items_ident: &proc_macro2::Ident) -> TokenStream2 {
    match node {
...
pub fn gen_grid_if_push(node: &IfNode, items_ident: &proc_macro2::Ident) -> TokenStream2 {
...
pub fn gen_element_without_grid(element: &Element) -> TokenStream2 {
