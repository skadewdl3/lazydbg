...
impl MiCommand for StackInfoFrame {
...
impl StackInfoDepth {
    ...
    pub fn with_max_depth(max_depth: u32) -> Self {
        Self {
            positional: Some(max_depth.to_string()),
        }
    }
}
impl MiCommand for StackInfoDepth {
...
impl StackListArguments {
    pub fn new(show_values: bool, frame_range: Option<(u32, u32)>) -> Self {
        ...
        if let Some((lo, hi)) = frame_range {
            positional.push(lo.to_string());
            positional.push(hi.to_string());
        }
        Self { positional }
    }
}
impl MiCommand for StackListArguments {
...
impl StackListFrames {
    ...
    pub fn range(low: u32, high: u32) -> Self {
        Self {
            positional: vec![low.to_string(), high.to_string()],
        }
    }
}
impl MiCommand for StackListFrames {
...
#[derive(Serialize, Default)]
pub struct StackListLocals {
    pub positional: String,
}
impl StackListLocals {
    pub fn new(print_values: bool) -> Self {
        Self {
            positional: if print_values { "1" } else { "0" }.to_string(),
        }
    }
}
impl MiCommand for StackListLocals {
...
#[derive(Serialize, Default)]
pub struct StackSelectFrame {
    pub positional: String,
}
impl StackSelectFrame {
    pub fn new(framenum: u32) -> Self {
        Self {
            positional: framenum.to_string(),
        }
    }
}
impl MiCommand for StackSelectFrame {
    const OP: &'static str = "stack-select-frame";
